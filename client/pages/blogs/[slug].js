...
const SingleBlog = ({blog,query})=>{
    ...
    const head = ()=>(
        <Head>
            ...
            <meta property="og:image" content={`http://localhost:4000/api/blog/photo/${blog.slug}`}/>
            <meta property="og:image:secure_url" content={`http://localhost:4000/api/blog/photo/${blog.slug}`}/>
                ...
                <article className="singleblog-foreground">
                    <div className="container-fluid">
                        ...
                        <div className="row" style={{marginTop:"0px"}}>
                            <img src={`http://localhost:4000/api/blog/photo/${blog.slug}`} alt={blog.title} className="img img-fluid background-image"/>
                        </div>
                        </section>
                        <section>
